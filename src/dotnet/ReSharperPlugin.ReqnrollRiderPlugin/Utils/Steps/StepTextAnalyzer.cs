...
public class AnalyzedStepParameter(string type, string name, string originalValue)
{
    public readonly string Type = type;
    public readonly string Name = name;
    public readonly string OriginalValue = originalValue;
...
internal class CaptureWithContext(Capture capture, ParameterType parameterType)
{
    public Capture Capture { get; } = capture;
