...
public class GherkinStep(GherkinStepKind stepKind, GherkinStepKind effectiveStepKind) : GherkinElement(GherkinNodeTypes.STEP)
{
    public GherkinStepKind StepKind { get; } = stepKind;
    public GherkinStepKind EffectiveStepKind { get; } = effectiveStepKind;
