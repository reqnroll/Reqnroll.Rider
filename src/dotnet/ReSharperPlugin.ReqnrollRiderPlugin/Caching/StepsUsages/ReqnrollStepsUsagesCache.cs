...
namespace ReSharperPlugin.ReqnrollRiderPlugin.Caching.StepsUsages
{
    ...
    public class ReqnrollStepsUsagesCache : SimpleICache<ReqnrollStepsUsagesCacheEntries>
    {
        ...
        public ReqnrollStepsUsagesCache(Lifetime lifetime, IShellLocks locks, IPersistentIndexManager persistentIndexManager, ILogger logger)
            : base(lifetime, locks, persistentIndexManager, new ReqnrollStepUsagesEntriesMarshaller(), VersionInt)
        {
            _logger = logger;
        }
