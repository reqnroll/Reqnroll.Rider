...
public class SyntaxErrorDaemonStageProcess(IDaemonProcess daemonProcess, GherkinFile file) : IDaemonStageProcess
{
    private readonly SyntaxErrorProcessor _elementProcessor = new();
