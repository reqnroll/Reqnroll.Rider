...
#line hidden
        ...
        public AdvancedExamplesMultipleTestcasesFeature(AdvancedExamplesMultipleTestcasesFeature.FixtureData fixtureData, SDKXUnit_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public virtual void TestCaseAddTwoNumbers(string first, string second, string result, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("TestCase: Add two numbers", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
